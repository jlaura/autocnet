...
"""):
    ...
    def cluster_propagate_control_network(self, base_cnet, walltime='00:20:00', chunksize=1000, exclude=None):
        ...
        submitter = Slurm('acn_propagate',
                     ...
                     time=walltime,
                     partition=self.config['cluster']['queue'],
                     output=self.config['cluster']['cluster_log_dir']+'/autocnet.cim-%j')
